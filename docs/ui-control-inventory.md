...
No visible control at this review point met the removable definition. RoadForge
does not expose deferred account, API, agent, webhook, billing, or PDF actions.
The retained contextual and advanced controls below are required for local-first
portability, collaboration, or recovery.
...
| Add phase | Essential | Append and immediately edit a phase | Local, owner, and editor; visible in every workspace view |
...
| Tags | Advanced | Inspect or maintain the roadmap tag registry | All roles can inspect; mutations follow edit permissions; visible “Tags” text |
...
| Phase reorder | Contextual | Change phase order | Local, owner, and editor in an unfiltered roadmap; drag handle plus keyboard/non-drag action |
...
| Task reorder | Contextual | Change task order | Local, owner, and editor in an unfiltered, collapsed task list; drag and non-drag alternatives |
...
The review found action density, not dead functionality. Primary creation and
recovery actions remain visible without hover. Advanced controls remain
state-scoped: import/export preserves portability, tags preserve roadmap
validity, versions and activity preserve audit/recovery, and phase settings hold
structural actions that should not compete with “Add phase.”
